window.ydoc_plugin_search_json = {
    "Documentação": [{
            "title": "Introdução",
            "content": " Ferramenta de Monitoramento de hardware altamente personalizável，baseada na nossa API Linus.，Para usar o Linus, você precisa preparar alguns equipamentos e instalar algumas ferramentas com antecedência",
            "url": "/documents/index.html",
            "children": [{
                "title": "Como usar",
                "url": "/documents/index.html#ComoUsar",
                "content": "Como usar e instalar dependências: para usar o QScan, você precisa preparar vários dispositivos e instalar algumas ferramentas com antecedência \n nTutorial de uso: uso específico\n"
            }]
        },
        {
            "title": "instalação",
            "content": "Para usar o Linus, você precisa ",
            "url": "/documents/install.html",
            "children": [{
                    "title": "Ferramenta de instalação",
                    "url": "/documents/install.html#Ferramenta de instalação",
                    "content": "A ferramenta de instalação Fastech depende dos seguintes dispositivos e ferramentas: \ n \ ndispositivo \ nversão \ n \ n \ n \ n \ n \ ndispositivo macOS \ n> = v8.0 \ n \ n \ nDispositivo Android \ n> = v4.4 \ n \ n \ n \ n \ nFerramentas \ nVersão \ n \ n \ n \ n \ nNó \ n> = v8.0 \ n \ n \ nAppium \ nVersão mais recente \ n \ n \ nWeChat instalado em dispositivos Android Aplicativo \ nv6.7.2 \ n \ n \ n"
                },
                {
                    "title": "1 Node.js",
                    "url": "/documents/install.html#-1-node.js",
                    "content": "1 Node.jsSolução 1: Baixe o pacote de instalação do site oficial do Node.js. Solução 2: Use o Node Version Manager (NVM) para instalar o Node.js. Você pode instalar o NVM com o seguinte comando: cURL: $ curl -o- https://raw.githubusercontent.com /creationix/nvm/v0.33.2/install.sh | bashWget: $ wget -qO- https://raw.githubusercontent.com/creationix/nvm/v0.33.2/install.sh | bashNVM Após a instalação, reinicie o terminal e Execute o seguinte comando para instalar o Node.js: nvm install stable"
                },
                {
                    "title": "2. 安装 Appium",
                    "url": "/documents/install.html#-2-appium",
                    "content": "2. 安装 Appium请按照这篇教程进行安装：Mac 上安装 Appium 详解"
                },
                {
                    "title": "3. Android 设备安装微信应用",
                    "url": "/documents/install.html#-3-android",
