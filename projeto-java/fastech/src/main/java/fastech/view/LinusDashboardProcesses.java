 ...
 * @author Jose Lucas
 */
public class LinusDashboardProcesses extends javax.swing.JFrame {

    /** Creates new form LinusDashboardProcesses */
    public LinusDashboardProcesses() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LinusDashboardProcesses.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LinusDashboardProcesses().setVisible(true);
            }
        });
    }
