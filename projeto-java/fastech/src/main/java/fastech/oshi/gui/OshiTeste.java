...
public class OshiTeste {
    ...
    private static final Logger logger = LoggerFactory.getLogger(OshiTeste.class);
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Disco: " + hal.getDiskStores());
    ...
    private static void printProcesses(OperatingSystem os, GlobalMemory memory) {
        ...
        // Sort by highest CPU
        List<OSProcess> procs = os.getProcesses(25, OperatingSystem.ProcessSort.CPU);
