 ...
 * @author Jose Lucas
 */
public class LinusDashboard extends javax.swing.JFrame {

    /**
     * Creates new form LinusDashboard
     */
    public LinusDashboard() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LinusDashboard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LinusDashboard().setVisible(true);
            }
        });
    }
